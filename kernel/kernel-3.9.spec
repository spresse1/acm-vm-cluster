...
- Updated to the 3.8.7 version source tarball.

* Sat Apr 06 2013 Alan Bartlett <ajb@elrepo.org> - 3.8.6-1
- Updated to the 3.8.6 version source tarball.

* Thu Mar 28 2013 Alan Bartlett <ajb@elrepo.org> - 3.8.5-1
- Updated to the 3.8.5 version source tarball.

* Thu Mar 21 2013 Alan Bartlett <ajb@elrepo.org> - 3.8.4-1
- Updated to the 3.8.4 version source tarball.

* Fri Mar 15 2013 Alan Bartlett <ajb@elrepo.org> - 3.8.3-1
- Updated to the 3.8.3 version source tarball.
...
- Updated to the 3.8.2 version source tarball.

* Tue Feb 28 2013 Alan Bartlett <ajb@elrepo.org> - 3.8.1-1
- Updated to the 3.8.1 version source tarball.
...
- Updated to the 3.8 version source tarball.

* Mon Feb 18 2013 Alan Bartlett <ajb@elrepo.org> - 3.7.9-1
- Updated to the 3.7.9 version source tarball.

* Fri Feb 15 2013 Alan Bartlett <ajb@elrepo.org> - 3.7.8-1
- Updated to the 3.7.8 version source tarball.

* Tue Feb 12 2013 Alan Bartlett <ajb@elrepo.org> - 3.7.7-1
- Updated to the 3.7.7 version source tarball.
...
- Updated to the 3.7.6 version source tarball.

* Mon Jan 28 2013 Alan Bartlett <ajb@elrepo.org> - 3.7.5-1
- Updated to the 3.7.5 version source tarball.
...
- Updated to the 3.7.4 version source tarball.

* Sat Jan 19 2013 Alan Bartlett <ajb@elrepo.org> - 3.7.3-1
- Updated to the 3.7.3 version source tarball.
...
- Updated to the 3.7.2 version source tarball.
...
- Updated to the 3.7.1 version source tarball.
...
- Updated to the 3.7 version source tarball.

* Tue Dec 11 2012 Alan Bartlett <ajb@elrepo.org> - 3.6.10-1
- Updated to the 3.6.10 version source tarball.
